...
const LoginPage = () => {
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-white font-sans">
      ...
      <div className="w-full md:w-[45%] flex flex-col p-6 md:p-12">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-8 md:p-10 w-full max-w-md mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2">
            Welcome to the <span className="text-green-700">Student</span> Loan
            Portal
          </h2>
          ...
          <div className="mt-6 text-center text-xs text-gray-500">
            Reset your password using your{" "}
            <span className="text-green-600 font-bold cursor-pointer">
              Email address
            </span>{" "}
            or{" "}
            <span className="text-green-600 font-bold cursor-pointer">NIN</span>
          </div>
        </div>
      ...
      <div className="hidden md:block flex-1 bg-gradient-to-br from-[#4ade80] via-[#22c55e] to-[#15803d]"></div>
    </div>
  );
};
